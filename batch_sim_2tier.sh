...
tmp_dir='/home/yz2297/qsim/logs/2tier/validation/rapl/8p_ngx_2.0GHz_4t_memc_1.8Ghz_20irq_conn_'$numConns
mkdir -p $tmp_dir
...
do 
	...
	touch $filename
	./microsim ./architecture/2tier/ $totalJobs $numConns $netLat expo $qps > $filename 
