...
tmp_dir='/home/zhangyanqi/qsim/logs/memcached/path_based/rapl/8thd_nConn_'$numConns'_total_job_'$totalJobs'_20irq_1.2GHz'
mkdir -p $tmp_dir
...
do 
	...
	touch $filename
	./microsim ./architecture/memcached/ $totalJobs $numConns $netLat expo $qps > $filename 
