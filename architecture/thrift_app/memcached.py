...
def main():
	...
	recvTm = march.make_time_model("expo", [1500])
	respTm = None
	socket_stage = march.make_stage(stage_name = "sock_read", pathId = 0, pathStageId = 1, stageId = 1, blocking = False, batching = True, socket = True, 
		epoll = False, ngx = False, net = False, chunk = False, recvTm = recvTm, respTm = respTm, cm = None, criSec = False, threadLimit = None,
		scaleFactor = 0.35, useHist = True)

	recvTm = march.make_time_model("expo", [600])
	respTm = None
	read_stage = march.make_stage(stage_name = "memc_proc", pathId = 0, pathStageId = 2, stageId = 2, blocking = False, batching = False, socket = False, 
		epoll = False, ngx = False, net = False, chunk = False, recvTm = recvTm, respTm = respTm, cm = None, criSec = False, threadLimit = None, 
		scaleFactor = 0.45, useHist = True)

	recvTm = march.make_time_model("expo", [7500])
	respTm = None
	send_stage = march.make_stage(stage_name = "memc_send", pathId = 0, pathStageId = 3, stageId = 3, blocking = False, batching = False, socket = False, 
		epoll = False, ngx = False, net = True, chunk = False, recvTm = recvTm, respTm = respTm, cm = None, criSec = False, threadLimit = None, 
		scaleFactor = 0.3, useHist = True)
	...
	recvTm = march.make_time_model("expo", [1500])
	respTm = None
	socket_stage = march.make_stage(stage_name = "sock_read", pathId = 1, pathStageId = 1, stageId = 1, blocking = False, batching = True, socket = True, 
		epoll = False, ngx = False, net = False, chunk = False, recvTm = recvTm, respTm = respTm, cm = None, criSec = False, threadLimit = None,
		scaleFactor = 0.35, useHist = True)

	recvTm = march.make_time_model("expo", [800])
	respTm = None
	write_stage = march.make_stage(stage_name = "memc_proc", pathId = 1, pathStageId = 2, stageId = 4, blocking = False, batching = False, socket = False, 
		epoll = False, ngx = False, net = False, chunk = False, recvTm = recvTm, respTm = respTm, cm = None, criSec = False, threadLimit = None,
		scaleFactor = 0.45, useHist = True)

	recvTm = march.make_time_model("expo", [7500])
	respTm = None
	send_stage = march.make_stage(stage_name = "memc_send", pathId = 1, pathStageId = 3, stageId = 3, blocking = False, batching = False, socket = False, 
		epoll = False, ngx = False, net = True, chunk = False, recvTm = recvTm, respTm = respTm, cm = None, criSec = False, threadLimit = None,
		scaleFactor = 0.3, useHist = True)
