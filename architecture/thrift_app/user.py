...
def main():
	...
	respTm = None
	proc_stage = march.make_stage(stage_name = "user_proc", pathId = 0, pathStageId = 0, stageId = 0, blocking = False, batching = False, socket = False, 
	...
	# user
	user = march.make_micro_service(servType = "micro_service", servName = "user", bindConn = True, paths = [req_path], 
