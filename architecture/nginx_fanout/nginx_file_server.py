...
def main():
	# req path
	# recvTm = march.make_time_model("expo", [1.5])	# 1.5 us
	...
	# recvTm = march.make_time_model("expo", [19.0])	# 19 us
	...
	# nginx
	nginx = march.make_micro_service(servType = "micro_service", servName = "nginx_file_server", bindConn = True, paths = [req_path], 
		baseFreq = 2600, curFreq = 2600)

	with open("./json/microservice/nginx_file_server.json", "w+") as f:
