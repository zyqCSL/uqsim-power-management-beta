...
def main():
	...
	read_path = march.make_code_path(pathId = 0, prob = 100, stages=[epoll_stage, socket_stage, read_stage, send_stage], priority = None)
	...
	write_path = march.make_code_path(pathId = 1, prob = 0, stages=[epoll_stage, socket_stage, write_stage, send_stage], priority = None)
